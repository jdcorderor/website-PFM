...
export default function AboutUs() {
    ...
    return (
        <section id="nosotros" ref={ref} className="flex flex-col w-full">
            <section className="relative w-full min-h-110 md:min-h-screen md:py-36">
                ...
                <div className={`relative inset-0 z-10 flex flex-col w-[85vw] gap-8 mx-auto ${ sectionVisible ? "slide-from-bottom" : "opacity-0"}`}>
                    <div className="flex flex-col gap-4">
                        <h2 className="md:text-5xl font-montserrat text-white font-bold text-center">Nuestra trayectoria</h2>
                        <p className="md:text-xl font-montserrat text-white font-light text-center"><i>Un legado de cultura, tradición y pasión por la música sinfónica</i></p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 items-center justify-center">
                        <div className="flex flex-col items-center bg-transparent gap-4">
                            <img src="/about/image1.png" alt="Programa de Formación Musical - Maestro José Calabrese" className="w-60 h-60 object-cover" />
                            <div className="flex flex-col justify-center items-center gap-1">
                                <span className="text-5xl font-montserrat text-white font-bold"><Counter target={200} suffix="+" visible={sectionVisible} /></span>
                                <p className="text-2xl font-montserrat text-white font-normal">Estudiantes</p>
                            </div>
                        </div>
                        <div className="flex flex-col items-center bg-transparent gap-4">
                            <img src="/about/image2.png" alt="Programa de Formación Musical - Maestro José Calabrese" className="w-60 h-60 object-cover" />
                            <div className="flex flex-col justify-center items-center gap-1">
                                <span className="text-5xl font-montserrat text-white font-bold"><Counter target={30} suffix="+" visible={sectionVisible} /></span>
                                <p className="text-2xl font-montserrat text-white font-normal">Cátedras</p>
                            </div>
                        </div>
                        <div className="flex flex-col items-center bg-transparent gap-4">
                            <img src="/about/image3.png" alt="Programa de Formación Musical - Maestro José Calabrese" className="w-60 h-60 object-cover" />
                            <div className="flex flex-col justify-center items-center gap-1">
                                <span className="text-5xl font-montserrat text-white font-bold"><Counter target={48} suffix="+" visible={sectionVisible} /></span>
                                <p className="text-2xl font-montserrat text-white font-normal">Años de historia</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section ref={gridRef} className="relative w-full md:min-h-screen">
                <div className="absolute inset-0 z-0 w-full grid md:grid-cols-2">
                    <div className={`flex w-full bg-gradient-to-b from-[#7A5C20] to-[#BFA75A] px-28 border-r-6 border-white items-center ${ gridVisible ? "slide-from-left" : "opacity-0" }`}>
                        <h2 className="md:text-7xl font-montserrat text-white text-left">El <b>hogar</b> de los <b>músicos</b> del <b>mañana</b></h2>
                    </div>
                    ...
                    <div className={`w-full grid grid-cols-3 gap-1 ${ gridVisible ? "slide-from-right" : "opacity-0" }`}>
                        {["grid1.JPG", "grid2.JPG", "grid3.JPG", "grid7.JPG", "grid4.JPG", "grid6.JPG", "grid5.JPG"].map((img, i) => (
                            <div key={i} className={`relative w-full h-full md:h-[33.3vh] ${img === "grid1.JPG" || img === "grid5.JPG" ? "col-span-2" : ""}`}>
                                <img src={`/about/${img}`} alt="Programa de Formación Musical - Maestro José Calabrese" className="w-full h-full object-cover" />
            ...
            <section ref={valuesRef} className="relative w-full min-h-110 md:min-h-screen md:py-42">
                <div className="absolute inset-0 z-0 w-full bg-gradient-to-b from-[#4B0C0C] to-[#7A1F1F] border-y-6 border-white"></div>
                    
                <div className={`relative inset-0 z-10 flex flex-col w-[85vw] gap-12 mx-auto ${ valuesVisible ? "slide-from-bottom" : "opacity-0" }`}>
                    <div className="flex flex-col gap-8">
                        <h2 className="md:text-5xl font-montserrat text-white font-bold text-center">Nuestra misión</h2>
                    ...
                    <div className="grid md:grid-cols-3 gap-18">
                        ...
                        <div className="w-full p-6 border-4 border-[#BFA760] rounded-3xl hover:scale-110 duration-400">
                            <p className="font-montserrat text-white font-medium text-center">Proporcionar a los participantes del Programa, la oportunidad de descubrir sus capacidades interpretativas en una formación orquestal, permitiéndoles desarrollarse como músicos profesionales potencialmente exitosos.</p>
                        </div>
                        <div className="w-full p-6 border-4 border-[#BFA760] rounded-3xl hover:scale-110 duration-400">
