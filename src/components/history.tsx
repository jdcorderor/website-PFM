        ...
        <section className="flex flex-col w-full">
            <section ref={gridRef} className="relative w-full md:min-h-screen">
                <div className="absolute inset-0 z-0 w-full grid md:grid-cols-2">
                    ...
                    <div className={`flex w-full bg-gradient-to-b from-[#7A5C20] to-[#BFA75A] px-24 border-l-6 border-white items-center ${ gridVisible ? "slide-from-right" : "opacity-0" }`}>
                        <h2 className="md:text-7xl font-montserrat text-white text-right">El <b>semillero</b> de la <b>Orquesta Sinfónica de Carabobo</b></h2>
                    </div>
                </div>
            </section>

            <section id="historia" ref={historyRef} className="relative w-full min-h-110 md:min-h-screen md:py-40">
                ...
                <div className={`relative inset-0 z-10 flex flex-col w-[85vw] gap-12 mx-auto ${ historyVisible ? "slide-from-bottom" : "opacity-0" }`}>
                    <div className="flex flex-col gap-10">
                        <h2 className="md:text-5xl font-montserrat text-white font-bold text-center leading-[7vh]">Nuestra historia, <span className="text-[#BFA760]">nuestro legado</span></h2>
                        <div className="grid md:grid-cols-2 gap-16 px-8 mx-auto">
                            <div className="flex flex-col gap-4">
                                <p className="md:text-xl font-montserrat text-white text-justify">
            ...
            <section ref={altGridRef} className="relative w-full min-h-110 md:min-h-screen">
                <div className="absolute inset-0 z-0 grid md:grid-cols-2 w-full border-t-6 border-white">
                    <div className={`flex w-full bg-gradient-to-b from-[#7A5C20] to-[#BFA75A] px-24 items-center ${ altGridVisible ? "slide-from-left" : "opacity-0" }`}>
                        <div className="flex flex-col gap-8">
                            <h2 className="md:text-5xl font-montserrat text-white font-bold text-left">El maestro, <br /> José Calabrese</h2>
                    ...
                    <div className={`relative w-full border-l-6 border-white ${ altGridVisible ? "slide-from-right" : "opacity-0" }`}>
                        <div className="grid grid-cols-2 gap-1">
                            <div className="flex flex-col gap-1">
                                ...
                                <div className="relative">
                                    <img src="/history/image4.jpg" alt="Maestro José Calabrese" className="w-full md:h-[39.5vh] object-cover" />
                                    <div className="absolute inset-0 bg-black/40"></div>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <div className="relative">
                                    <img src="/history/image5.jpg" alt="Maestro José Calabrese" className="w-full md:h-[40vh] object-cover" />
                                    <div className="absolute inset-0 bg-black/40"></div>
                                </div>
                            </div>         
                        </div>
