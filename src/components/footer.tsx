            ...
            <div className={`relative w-full border-t border-gray-200 ${ visible ? "slide-from-bottom" : "opacity-0" }`}>
                ...
                <div className="relative z-10 p-4 md:p-8 mx-auto">
                    <div className="w-full flex flex-col lg:flex-row flex-wrap items-center justify-center md:justify-between py-2 md:py-4 mx-auto">             
                        {/* Logos */}
                        <div className="flex flex-col items-center md:w-1/5 md:px-10 gap-5">
                            ...
                            <div className="flex flex-col gap-2">
                                <p className="w-full text-xs text-gray-800"><b>Salón MZ-08, Hotel Hesperia WTC</b> <br /> Naguanagua, Carabobo</p>
                                <p className="w-full text-xs text-gray-800"><b>Universidad José Antonio Páez</b> <br /> San Diego, Carabobo</p>
                            </div>
                        </div>
                    ...
                    {/* Copyright */}
                    <div className="w-full text-xs text-gray-800 text-center px-12 md:px-0 pb-6 mt-8 md:mt-6">
